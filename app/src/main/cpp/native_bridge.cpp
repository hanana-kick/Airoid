...
Java_com_airoid_bridge_NativeBridge_nativeInit(
...
Java_com_airoid_bridge_NativeBridge_nativeStart(
...
Java_com_airoid_bridge_NativeBridge_nativeStop(
...
extern "C"
JNIEXPORT void JNICALL
Java_com_airoid_bridge_NativeBridge_nativeDestroy(
        JNIEnv *env, jobject thiz, jlong handle) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_airoid_bridge_NativeBridge_nativeSetDisplaySize(
    ...
    /* UxPlay 기본 maxFPS=30이 송신을 30fps로 제한하므로 광고값으로 올린다 */
...
Java_com_airoid_bridge_NativeBridge_nativeDisconnectClients(
    ...
    /* server-initiated teardown: close every active RAOP/AirPlay connection */
...
Java_com_airoid_bridge_NativeBridge_nativeGetRaopTxtRecords(
        JNIEnv *env, jobject thiz, jlong handle) {
...
extern "C"
JNIEXPORT jobject JNICALL
Java_com_airoid_bridge_NativeBridge_nativeGetAirplayTxtRecords(
        JNIEnv *env, jobject thiz, jlong handle) {
...
Java_com_airoid_bridge_NativeBridge_nativeGetRaopServiceName(
        JNIEnv *env, jobject thiz, jlong handle) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_airoid_bridge_NativeBridge_nativeGetServerName(
        JNIEnv *env, jobject thiz, jlong handle) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_airoid_bridge_NativeBridge_nativeSetPlist(
...
extern "C"
JNIEXPORT void JNICALL
Java_com_airoid_bridge_NativeBridge_nativeSetH265Enabled(
...
extern "C"
JNIEXPORT void JNICALL
Java_com_airoid_bridge_NativeBridge_nativeSetHlsEnabled(
        JNIEnv *env, jobject thiz, jlong handle, jboolean enabled) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_airoid_bridge_NativeBridge_nativeSetAudioEnabled(
        JNIEnv *env, jobject thiz, jlong handle, jboolean enabled) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_airoid_bridge_NativeBridge_nativeSetCodecs(
...
extern "C"
JNIEXPORT void JNICALL
Java_com_airoid_bridge_NativeBridge_nativeUpdatePlaybackInfo(
        JNIEnv *env, jobject thiz, jlong handle,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_airoid_bridge_NativeBridge_nativeSetDefaultStreamValues(
...
Java_com_airoid_bridge_NativeBridge_nativeServerAudioStart(
        JNIEnv *env, jobject thiz, jlong handle) {
    server_ctx_t *ctx = (server_ctx_t *)(intptr_t)handle;
...
extern "C"
JNIEXPORT void JNICALL
Java_com_airoid_bridge_NativeBridge_nativeServerAudioStop(
        JNIEnv *env, jobject thiz, jlong handle) {
    server_ctx_t *ctx = (server_ctx_t *)(intptr_t)handle;
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_airoid_bridge_NativeBridge_nativeServerAudioConfigure(
...
extern "C"
JNIEXPORT void JNICALL
Java_com_airoid_bridge_NativeBridge_nativeServerAudioFormat(
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_airoid_bridge_NativeBridge_nativeServerAudioDebug(
